...
DEVANAGARI_INTENTS = {
    ...
    "day-nrlm": [
        ...
        # Single-mother / women's livelihood framings so this surfaces
        # as a supporting top-3 alongside PMJJBY for the demo query.
        "अकेली माँ हूँ कमाई कैसे करूँ",
        "अकेले बच्चे को पाल रही हूँ आय बढ़ानी है",
        "विधवा महिला के लिए आजीविका",
        "अकेले परिवार चलाने में मदद",
        "बेटी को पालने के लिए आर्थिक सहायता",
        "महिला के लिए बचत और लोन योजना",
    ],
    "pmjjby": [
        ...
        # Emotional / family-security framings — same intent as the
        # demo query "मैं अकेले अपनी बेटी को पाल रही हूँ, अगर मुझे कुछ
        # हो जाए तो उसका क्या होगा, सस्ता बीमा चाहिए."
        "अगर मुझे कुछ हो जाए तो बच्चों का क्या होगा",
        "मेरी मौत के बाद परिवार का सहारा",
        "अकेली माँ हूँ बेटी के लिए बीमा",
        "बेटी का भविष्य सुरक्षित करना है",
        "single mother life insurance",
        "मेरे ना रहने पर बेटी का सहारा",
        "अकेले बच्चे को पाल रही हूँ बीमा चाहिए",
        "गरीब महिला के लिए सस्ता जीवन बीमा",
        "बच्चों की सुरक्षा के लिए बीमा",
        "अगर मुझे कुछ हो जाए तो parivar surakshit rahe",
        "विधवा महिला के लिए जीवन बीमा",
    ],
    "pmmy": [
